...
7. To integrate PERF data source with services such as Jenkins, Sonar and GitLab you have to create secrets with administrative rights:
...
9. Install operator in the <edp_cicd_project> namespace with the helm command; find below the installation command example:
    ```bash
    ...
    ```
10. Check the <edp_cicd_project> namespace that should contain operator deployment with your operator in a running status.
